...
window which you can crawl into data or links to extract information """
    ...
    def director(self):
        try:
            dir_tag = self.driver.find_element(By.XPATH, dir_xpath)
            return dir_tag
        except:
            return None
    ...
    def actor_1(self):
        try:
            actr_tag = self.driver.find_element(By.XPATH, actr1_xpath).text
            return actr_tag
        except:
            return None
    ...
    def comment(self):
        try:
            comment_tag = self.driver.find_element(By.CLASS_NAME, comment_xpth).text
            return comment_tag
        except:
            return None
    ...
    def Getdata(self):
        ...
        while True:
            ...
            actor = Genre.create(name=self.genre)
            director = Director.create(name=self.genre)
